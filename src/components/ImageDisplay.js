...
class ImageDisplay extends Component{  
  ...
  render(){
    return(
      <div>
        <img className='singleImage' src={this.state.imageUrl} alt="Apple" onClick={()=>this.handlePopup(this.state.imageUrl)}/>

        {this.state.showModal ? (
          <Popup popImageUrl={this.state.popImageUrl} closePopup={this.handlePopup} />
        ):null}
